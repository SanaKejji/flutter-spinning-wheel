...
class SpinVelocity {
  ...
  int _getCuadrantFromOffset(Offset p) =>
  ...
  double _normalizeAngle(double angle) =>
      angle > 0 ? (angle > pi_0_5 ? (pi_2_5 - angle) : (pi_0_5 - angle)) : pi_0_5 - angle;
...
class NonUniformCircularMotion {
  ...
  /// 𝜑=𝜑0+𝜔·𝑡+1/2·𝛼·𝑡2
  distance(double velocity, double time) => (velocity * time) + (0.5 * acceleration * pow(time, 2));
